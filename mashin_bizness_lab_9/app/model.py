...
class Model(nn.Module):
    def __init__(self, config, word_mat, char_mat):
        ...
        self.linear_1 = nn.Sequential(nn.Linear(config.hidden*8, config.hidden), nn.ReLU())
        ...
        self.linear_2 = nn.Sequential(nn.Linear(config.hidden*8, config.hidden), nn.ReLU())
